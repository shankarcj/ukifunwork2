...
function addNote(){
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      ...
      document.getElementById("notes").innerHTML = "<tr><td id='id1'>"+data._id+"</td><td id='title1'>"+data.title+"</td><td id='body1'>"+data.text+"</td><td><button style='background-color:yellow;border-radius:10px' onclick='displayNote()'>Get Note</button></td><td><button style='background-color:yellow;border-radius:10px' onclick='editNote()'>Edit</button></td><td><button style='background-color:red;border-radius:10px' onclick='deleteNote()'>Delete</button></td></tr>";
